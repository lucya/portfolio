<template>
  <form class="form-container" @submit.prevent="handleSubmit" autocomplete="off">
    ...
    <div class="form-wrap">
      ...
      <input type="text" name="username" autocomplete="off" ref="usernameRef" @change.prevent="handleChange"
    ...
    <div class="form-wrap">
      ...
      <input type="password" name="password-confirm" autocomplete="off" placeholder="최소 6자 이상" @keyup.prevent="validator"
        @change.prevent="setPwdConfirm" required />
